...
export default function ProductDetailsClient({ productId, initialUser }: ProductDetailsClientProps) {
              ...
              <div className="grid grid-cols-2 gap-6 mb-8 p-4 bg-gray-50 rounded-xl">
                ...
                <div>
                  ...
                  <span className="font-semibold">
                    {isOutOfStock ? (
                      <span className="px-3 py-1 rounded-full text-xs font-bold bg-red-100 text-red-700">Out of Stock</span>
                    ) : (
